...
<!DOCTYPE html><html lang="en" data-layout-mode="detached" data-topbar-color="dark" data-menu-color="light" data-sidenav-user="true"><head>
    <meta charset="utf-8">
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="../web-logo-02.png">
                ...
                <div class="d-flex align-items-center gap-lg-2 gap-1">
                    ...
                    <div class="logo-topbar">
                        ...
                        <a href="index.html" class="logo-light">
                            <span class="logo-lg">
                                <img src="../web-logo-02.png"  alt="logo">
                            </span>
                            <span class="logo-sm">
                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            ...
                            <span class="d-lg-flex flex-column gap-1 d-none">
                                <h5 class="my-0">Kun Rolls & Bbq</h5>
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar="">
                ...
                <div class="leftbar-user">
                    <a href="pages-profile.html">
                        <img src="../web-logo-02.png" alt="user-image" height="50" >
                        <span class="leftbar-user-name mt-2">Kun Rolls & Bbq</span>
                    </a>
                </div>
                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav-title">Admin Controls</li>

                    <li class="side-nav-item">
                        <a data-bs-toggle="collapse" href="Kun_Order.php" aria-expanded="false" aria-controls="sidebarDashboards" class="side-nav-link">
                    ...
                    <li class="side-nav-item">
                        <a href="place_order.php" class="side-nav-link">
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <iframe overflow:scroll; style="    position: absolute;
    top: 0;
    left: 0;
    bottom: 0;
    right: 0;  border:0; " width="100%" height="100%"  src= "../upload_product.php" >
</body>
